...
//        repositoryService.deleteDeployment(deploymentId);
     ...
     */
    @Test
    public void getDeployment() throws IOException, IOException {
//         1、得到引擎
        ProcessEngine processEngine = ProcessEngines.getDefaultProcessEngine();
...
//        6、构造OutputStream流
        File pngFile = new File("d:/workscpace/huate/evectionflow01.png");
        File bpmnFile = new File("d:/workscpace/huate/evectionflow01.bpmn");
